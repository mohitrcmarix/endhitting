...
class Updater
{
     ...
     */
    public function __construct($_api_url, $_plugin_file, $_api_data = null, $_plugin_update_data = [])
    {
    ...
    public function plugins_api_filter($_data, $_action = '', $_args = null)
    {
        ...
        if (!in_array($_args->slug, [$this->slug, 'wppayform'])) {
            return $_data;
        }
    ...
    public function show_changelog()
    {
        ...
        if (!current_user_can('update_plugins')) {
            wp_die(
                __('You do not have permission to install plugin updates', 'edd'),
                __('Error', 'edd'),
                array('response' => 403)
            );
        }
