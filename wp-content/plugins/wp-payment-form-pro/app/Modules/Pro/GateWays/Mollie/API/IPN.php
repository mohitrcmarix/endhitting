...
namespace WPPayForm\App\Modules\Pro\GateWays\Mollie\API;
...
use WPPayForm\App\Modules\Pro\GateWays\Mollie\MollieSettings;
...
class IPN
{
    ...
    {
        $apiKey = (new MollieSettings())->getApiKey($formId);
