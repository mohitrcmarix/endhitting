...
class MailChimpIntegration extends IntegrationManager
{
    ...
    public function __construct($application)
    {
        ...
        $this->description = 'WPPayForms Mailchimp module allows you to create Mailchimp newsletter signup forms in WordPress';
    ...
    public function getGlobalFields($fields)
    {
        return [
            'logo'             => $this->logo,
            'menu_title'       => __('Mailchimp Settings', 'wppayform'),
            'menu_description' => __('Mailchimp is a marketing platform for small businesses. Send beautiful emails, connect your e-commerce store, advertise, and build your brand. Use WPPayForm to collect customer information and automatically add it to your Mailchimp campaign list. If you don\'t have a Mailchimp account, you can <a href="http://www.mailchimp.com/" target="_blank">sign up for one here.</a>', 'wppayform'),
            'valid_message'    => __('Your Mailchimp API Key is valid', 'wppayform'),
            'invalid_message'  => __('Your Mailchimp API Key is not valid', 'wppayform'),
            'save_button_text' => __('Save Settings', 'wppayform'),
            'fields'           => [
                'apiKey' => [
                    'type'       => 'text',
                    'label_tips' => __("Enter your Mailchimp API Key, if you do not have <br>Please login to your MailChimp account and go to<br>Profile -> Extras -> Api Keys", 'wppayform'),
                    'label'      => __('Mailchimp API Key', 'wppayform'),
                ]
            ],
            'hide_on_valid'    => true,
            'discard_settings' => [
    ...
    public function saveGlobalSettings($mailChimp)
    {
        if (!$mailChimp['apiKey']) {
            ...
            wp_send_json_success([
                'message' => __('Your settings has been updated and disconnected', 'wppayform'),
                'status'  => false
            ], 200);
        }
        ...
        wp_send_json_success([
            'message' => __('Your mailchimp api key has been verified and successfully set', 'wppayform'),
            'status'  => true
        ], 200);
    }
    ...
    public function pushIntegration($integrations, $formId)
    {
        $integrations['mailchimp'] = [
            'title' => __('Mailchimp Feed', 'wppayform'),
            'logo' => $this->logo,
            ...
            'configure_message' => __('Mailchimp is not configured yet! Please configure your mailchimp api first', 'wppayform'),
            'configure_button_text' => __('Set Mailchimp API', 'wppayform')
        ];
        ...
        return [
            'fields' => [
                ...
                [
                    ...
                    'require_list' => true,
                    'label' => 'Map Fields',
                    'tips' => 'Associate your Mailchimp merge tags <br/> to the appropriate WPPayForm fields <br/> by selecting the appropriate form <br/> field from the list.',
                ...
                [
                    ...
                    'require_list' => true,
                    'label' => 'Tags',
                    'tips' => 'Associate tags to your MailChimp contacts <br/> with a comma separated list (e.g. new lead, WPPayForms, web source). <br/>Commas within a merge tag value will be created as a single tag.',
