...
// ALWAYS CHECK TO MAKE SURE PublishPress Series IS RUNNING FIRST //
...
function orgseries_grouping_taxonomy() {
    ...
    $labels = array(
        'name' => _x('Manage Series Groups', 'taxonomy general name', 'publishpress-series-pro'),
        'singular_name' => _x('Series Group', 'taxonomy singular name', 'publishpress-series-pro'),
        'search_items' => __('Search Series Groups', 'publishpress-series-pro'),
        'popular_items' => __('Popular Series Groups', 'publishpress-series-pro'),
        'all_items' => __('All Series Groups', 'publishpress-series-pro'),
        'edit_item' => __('Edit Series Group', 'publishpress-series-pro'),
        'update_item' => __('Update Series Group', 'publishpress-series-pro'),
        'add_new_item' => __('Add New Series Group', 'publishpress-series-pro'),
        'new_item_name' => __('New Series Group', 'publishpress-series-pro'),
        'menu_name' => __('Series Groups', 'publishpress-series-pro')
    );
    $args = array(
    ...
    ?>
        	<tr valign="top">
            	<th scope="row"><label for="kill_grouping_on_delete">
                    <?php _e('Series Grouping Feature', 'publishpress-series-pro'); ?>
                	</label>
            	</th>
            	<td>
                    <label>
                    ...
                    <span class="description"><?php _e('Delete all "Series Grouping" data from the database when deleting the plugin.', 'publishpress-series-pro'); ?></span>
                	</label>
                </td>
        	</tr>
    <?php
...
function series_grouping_columns($columns) {
    unset($columns['posts']);
    $columns[''.ppseries_get_series_slug().''] =  __('Series', 'publishpress-series-pro');
    return $columns;
}
...
function manage_series_grouping_columns($columns) {
    global $pagenow;
    $columns['group'] = __('Group(s)', 'publishpress-series-pro');
    return $columns;
}
...
function manage_series_grouping_columns_inside($content, $column_name, $id) {
    ...
    if ($column_name == 'group') {
        ...
        if ( $groups = wp_get_object_terms($group_id, 'series_group') ) {
            ...
            $column_return .= __('No group', 'publishpress-series-pro');
        ...
        <div id="side-info-column" class="inner-sidebar">
            <div id="side-sortables" class="meta-box-sortables">
                <div id="categorydiv" class="postbox">
                    <div class="handlediv" title="<?php _e('Click to toggle'); ?>"><br /></div><h3 class='hndle'><span><?php _e('Groups', 'publishpress-series-pro'); ?></span></h3>
                    <div class="inside">
...
function orgseries_group_inline_edit($column_name, $type, $taxonomy) {
    ...
    if ( $taxonomy == ppseries_get_series_slug() && $column_name == 'group' ) { //takes care of WP3.1 changes (prevents duplicate output)
        ...
        <fieldset class="inline-edit-col-right inline-edit-categories"><div class="inline-edit-col">
			<span class="title inline-edit-categories-label"><?php _e('Groups', 'publishpress-series-pro'); ?>
