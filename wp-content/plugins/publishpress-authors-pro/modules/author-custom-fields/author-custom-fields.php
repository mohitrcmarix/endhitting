...
use PPAuthorsPro\CustomFieldsModel;
...
class MA_Author_Custom_Fields extends Module
{
    ...
    public function __construct()
    {
        ...
        $args = [
            'title' => __('Author Fields', 'publishpress-authors-pro'),
    ...
    {
        $labelSingular = __('Author Field', 'publishpress-authors-pro');
        $labelPlural = __('Author Fields', 'publishpress-authors-pro');

        $postTypeLabels = [
            'name' => _x('%2$s', 'Custom Field post type name', 'publishpress-authors-pro'),
            'singular_name' => _x(
                '%1$s',
            ...
            'parent_item_colon' => '',
            'menu_name' => _x('%2$s', 'custom field post type menu name', 'publishpress-authors-pro'),
    ...
    public function adminSubmenu()
    {
        ...
        add_submenu_page(
            ...
            esc_html__('Author Fields', 'publishpress-authors-pro'),
            esc_html__('Fields', 'publishpress-authors-pro'),
    ...
    public function setPostUpdateMessages($messages)
    {
        $messages[self::POST_TYPE_CUSTOM_FIELDS] = [
            1 => __('Custom Field updated.', 'publishpress-authors-pro'),
            4 => __('Custom Field updated.', 'publishpress-authors-pro'),
            6 => __('Custom Field published.', 'publishpress-authors-pro'),
            7 => __('Custom Field saved.', 'publishpress-authors-pro'),
            8 => __('Custom Field submitted.', 'publishpress-authors-pro'),
        ];
    ...
    public function setPostBulkUpdateMessages($messages, $counts)
    {
        ...
        $postTypeNameSingular = __('Custom Field', 'publishpress-authors-pro');
        $postTypeNamePlural = __('Custom Fields', 'publishpress-authors-pro');
    ...
    public function renderMetaboxes()
    {
        ...
        $metabox->add_field(
            [
                'name' => __('Field Slug', 'publishpress-authors-pro'),
        ...
        $metabox->add_field(
            [
                'name' => __('Field Type', 'publishpress-authors-pro'),
        ...
        $metabox->add_field(
            [
                'name' => __('Description', 'publishpress-authors-pro'),
                'desc' => __(
    ...
    public function filterFieldColumns($columns)
    {
        ...
        $newColumns = [
            'cb' => $columns['cb'],
            'title' => $columns['title'],
            'slug' => __('Slug', 'publishpress-authors-pro'),
        ];
